...
app.client = {
        ...
        try {
            ...
            citas.forEach(cita => {
                ...
                div.innerHTML = `
                    ...
                    <strong style="display:block; margin-right: 3rem;">${servicio.nombre}</strong>
                    ...
                    <span style="display:inline-block; margin-top:0.25rem;"><i class="far fa-money-bill-alt"></i> ${servicio.precio}€</span>
                `;
    ...
    editCita: function(cita) {
        ...
        app.bookingWizard.startEditFlow(cita, servicio);
    },
