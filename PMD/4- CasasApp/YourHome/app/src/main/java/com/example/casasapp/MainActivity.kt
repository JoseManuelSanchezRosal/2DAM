...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val viewModel: CasaViewModel = viewModel() // ViewModel compartido para todas las pantallas

            // CLAVE: Grafo de Navegación
            NavHost(navController = navController, startDestination = "inicio") {
                ...
                // Ruta con argumento opcional para Editar vs Crear
                composable(
